...
class _HandicapCardState extends State<_HandicapCard> {
  ...
  static const String _firstParas =
  ...
  static const String _secondParas =
            ...
            if (widget.isAdmin)
              Row(
                ...
                children: [
                  ElevatedButton.icon(
                    onPressed: () {
                      // Default create event without selecting a specific race
                      final placeholder = _HandicapRace(
                        id: 'new',
                        title: 'Handicap',
                        date: '',
                        venue: '',
                      );
                      widget.onCreateEvent(placeholder);
                    },
            ...
            children: [
              ...
              if (widget.isAdmin)
                TextButton.icon(
                  ...
                  icon: const Icon(Icons.add_box_outlined, color: Color(0xFFFFD700)),
                  label: const Text('Create Event'),
                ),
            ],
          ),
            ...
            children: [
              ...
              if (widget.isAdmin)
                IconButton(
                  ...
                  icon: const Icon(Icons.edit_calendar, color: Color(0xFFFFD700)),
                ),
            ],
          ),
          const SizedBox(height: 8),
            ...
            children: [
              ...
              if (widget.isAdmin)
                IconButton(
                  ...
                  icon: const Icon(Icons.edit_location_alt, color: Color(0xFFFFD700)),
                ),
            ],
          ),
        ],
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          crossAxisAlignment:
              info.keyId == 'eaccl' ? CrossAxisAlignment.center : CrossAxisAlignment.start,
          children: [
            Row(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
...
import 'package:url_launcher/url_launcher.dart';
        ...
        children: [
          ...
          Row(
            ...
            SingleChildScrollView(
              padding: const EdgeInsets.only(top: headerHeight + 16, bottom: 8),
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Container(
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              const Icon(Icons.event, color: Color(0xFFFFD700), size: 18),
              const SizedBox(width: 8),
              Text(
                r.date,
                style: const TextStyle(
          ...
          Row(
            children: [
              const Icon(Icons.place, color: Color(0xFFFFD700), size: 18),
              const SizedBox(width: 8),
              Expanded(
                child: Text(
                  r.venue,
  ...
  void _createEventFrom(_HandicapRace r) {
    final distance = _mapHandicapDistance(r.title);
    final date = _parseDateLabel(r.date);
    final venue = r.venue != 'TBD' ? r.venue : null;
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (_) => AdminCreateEventPage(
  ...
  String? _mapHandicapDistance(String title) {
    final t = title.toLowerCase();
    if (t.contains('5k')) return '5K';
    if (t.contains('10k')) return '10K';
    if (t.contains('10 mile') || t.contains('10 mi')) return '10M';
    if (t.contains('7 mile') || t.contains('7 mi')) return '7M';
    if (t.contains('5 mile') || t.contains('5 mi')) return '5M';
    if (t.contains('beach')) return 'Beach Run';
    return null;
  }
