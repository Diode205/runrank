...
class RaceDetailsPage extends StatefulWidget {
  ...
  const RaceDetailsPage({super.key, required this.event});
...
class _RaceDetailsPageState extends State<RaceDetailsPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final runningCount = _counts['running'] ?? 0;
    final marshallingCount = _counts['marshalling'] ?? 0;
              ...
              children: [
                Expanded(
                  child: ElevatedButton(
                    onPressed: () => _handleResponse('running'),
                ...
                Expanded(
                  child: ElevatedButton(
                    onPressed: () => _handleResponse('marshalling'),
                    style: ElevatedButton.styleFrom(
