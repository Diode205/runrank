...
mixin EventDetailsBaseMixin<T extends StatefulWidget> on State<T> {
  ...
  Future<void> loadResponses() async {
    ...
    // Restrict the default participant headcount to the
    // viewer's club so multi-club setups stay isolated.
    String? clubName;
    try {
      ...
      debugPrint(
        'EventDetailsBaseHead: error resolving club for totalUsers: $e',
      );
    }
